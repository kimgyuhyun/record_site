...
그림 번호 → [1 갱신 작업 큐](#1-비동기-전적-갱신-작업-큐-redis) · [3 레이트 리미터](#3-공유-레이트-리미터) · [4 랭킹 스냅샷](#4-랭킹-스냅샷-스케줄러) · [5 캐시](#5-redis-캐시) · 망 구성 상세는 [아키텍처](#아키텍처)
...
| `DB_PASSWORD` | MySQL root 비밀번호 (**필수** — 기본값 폴백 없음) | — |
